      ...
      <div class="offcanvas-body">
        ...
        <div class="my-3">
          <ul class="lead">
              ...
              <li class="mb-2 ms-4"><a href="#" class="text-decoration-none">Questionhiiii</a></li>
...
<br><br><br><br>
<h3 style="text-align:center">      Add Salary Details</h3>
<br>



<form method="post" action="/saveSalary" enctype="multipart/form-data">
{{csrf_field()}}
<div class="container mt-3">
<div class="form-group">
    <label for="teacher_id">Teacher_id:</label>
    <input type="number" class="form-control" placeholder="Teacher ID" name="Teacher_id" id="name1" min="1" max="99999"
  title="Must contain a integer number with 1- 8 charactors " required>
  </div>
  <div class="form-group">
    <label for="month">month:</label>
    <input type="text" class="form-control" placeholder="month" name="month" id="name2" pattern="[A-Za-z]{3,9}" title="input month name" required>
  </div>
 <div class="form-group">
    <label for="amount">Amount:</label>
    <input type="number" class="form-control" placeholder="Enter amount" name="amount" id="name3"   step="0.01" min="0"  required>
  </div>
  <br>
