...
<center>
    <h1><b>Physical Science Classes<b></h1>
  <br>
<i>
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <br><br><br>
    <a href="/Physics" name="btn-1" class="btn btn-primary">View</a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/Chemistry" name="btn-1" class="btn btn-primary">View</a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/Com-math " name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/physics-paper" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/chemistry-paper" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/Com-ppr " name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
