...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
   ...
   <div class="col-md-20">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control py-2" name="e_id" placeholder="Enter the lesson name">
    </div>
     @error('ClassLname')
    ...
    <input type="text" class="form-control py-2" name="std_id" placeholder="Enter the lesson type">
    </div>
    @error('classLtype')
    <div class="alert alert-success mt-1 mb-1">{{ $message }}</div>
    @enderror
