...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/ICT " name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/Sinhala" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/English" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/Tamil " name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <img src="images/classTeacher2.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h4><b>Geethma Edirisinghe</b></h4>
     <h5><b>Music</b></h5>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/Music" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <img src="images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h4><b>Ashoka Vithanage</b></h4>
     <h5><b>History</b></h5>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/History" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <img src="images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h4><b>Surath Ariyasinghe</b></h4>
     <h5><b>English Literature</b></h5>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/Elit" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <img src="images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h4><b>Charitha Dunusinghe</b></h4>
     <h5><b>Commerce</b></h6>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/Commerce" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
</i>
