...
<body>
    ...
    <h1 class="large text-primary">Update {{Auth::user()->first_name}}'s Details </h1>
    <p class="lead"><i class="fas fa-user"></i> Update My Data</p>

    <form action="/accountant/accountant-edit" method="POST" class="form">
    ...
    <input type="hidden" name="id" value="{{$data['id']}}">
        ...
        <div class="form-group">
          ...
          <input type="password" minlength="6" name="password" value="{{$data['password']}}" id="myInput" />
          <input type="checkbox" onclick="myFunction()" id="checkBox">Show Password
          <span class="text-danger">
        ...
        <div class="form-group">
          ...
          <input type="password" minlength="6" name="cpassword" value="{{$data['cpassword']}}" id="myInput2" />
          <input type="checkbox" onclick="myFunction2()" id="checkBox">Show Password
          <span class="text-danger">
        ...
        <div class="form-group">
          <input type="submit" value="Update My Data" class="btn btn-success" />
        </div>
