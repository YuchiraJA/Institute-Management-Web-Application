...
<body>
    ...
    <nav class="navigaation-bar background-dark">
      ...
      <ul>
        ...
        <li><a href="#">Q & A</a></li>
        <li><a href="/accountant/salary">Finance</a></li>
        <li>
    ...
    <section class="container">
      ...
      <div class="dash-buttons">
        <a href={{"accountant-edit/".Auth::id()}} class="btn">
      ...
      <div class="my-2">
        <button class="btn btn-danger" href="{{route ('accountant.logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> <i class="fas fa-sign-out-alt"></i> Logout</a>
        <form action="{{route ('accountant.logout')}}" method="POST" class="d-none" id="logout-form">>
          @csrf
        </form>
        </button>
      </div>
