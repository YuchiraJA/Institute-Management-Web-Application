...
<body>
    ...
    <h2 class="my-2 large text-primary fw-bold">Current Librarians List in MicroEye</h2>
      <table class="table">
        <thead>
          <tr>
            <th >ID</th>
          ...
          <tr>
            ...
            <td>
                <button class="btn btn-danger">
                  <i class="fas fa-user-minus"></i><a style="color: #fff !important;" href="{{'librarian-delete/'.$users['id']}}"> Delete librarian</a> 
                </button>
            </td>
          </tr>
          @endforeach
