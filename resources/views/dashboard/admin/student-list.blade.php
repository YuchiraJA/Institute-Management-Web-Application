...
<body>
    ...
    <h2 class="my-2 large text-primary fw-bold">Current Students List in MicroEye</h2>
      <table class="table">
        <thead>
          <tr>
            <th >ID</th>
          ...
          <tr>
            ...
            <td>
                <button class="btn btn-danger">
                  <i class="fas fa-user-minus"></i><a style="color: #fff !important;" href="{{'student-delete/'.$users['id']}}"> Delete Student</a> 
                </button>
            </td>
          </tr>
          @endforeach
