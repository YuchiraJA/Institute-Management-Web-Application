...
<body>
    ...
    <h2 class="my-2 large text-primary fw-bold">Current Teachers List in MicroEye</h2>
      <table class="table">
        <thead>
          <tr>
            <th >ID</th>
          ...
          <tr>
            ...
            <td>
                <button class="btn btn-danger">
                  <i class="fas fa-user-minus"></i><a style="color: #fff !important;" href="{{'teacher-delete/'.$users['id']}}"> Delete teacher</a> 
                </button>
            </td>
          </tr>
          @endforeach
