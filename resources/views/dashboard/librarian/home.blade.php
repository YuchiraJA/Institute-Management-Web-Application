   ...
   <nav class="navigaation-bar background-dark">
    ...
    <section class="container">
      ...
      <div class="dash-buttons">
        <a href={{"librarian-edit/".Auth::id()}} class="btn">
      ...
      <div class="my-2">
        <button class="btn btn-danger" href="{{route ('librarian.logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> <i class="fas fa-sign-out-alt"></i> Logout</a>
        <form action="{{route ('librarian.logout')}}" method="POST" class="d-none" id="logout-form">>
          @csrf
        </form>
        </button>
      </div>
