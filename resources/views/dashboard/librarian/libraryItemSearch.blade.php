@extends('librarian.manage_libraryitems')
...
<div class="container2">
    ...
    <form action="/librarian/save_libraryitem" method="post" enctype="multipart/form-data" style="border:1px solid #ccc">
    ...
    @endforeach
               ...
               <label for="itemdetails"><b>Library Item Details</b></label><br>
                ...
                <label for="itemlink"><b>Choose Image</b></label><br>
                   ...
                   <input type="file"  class="custom-file-label" for="customFile" name="image">
...
<table id="customers">
  ...
  <tr>
    ...
    <td>  
    <a href="/librarian/deletelibraryitem/{{$libraryitem->id}}" id="btn1" class="btn btn-warning">Delete</a>
    <a href="/librarian/updatelibraryitem/{{$libraryitem->id}}" id="btn2" class="btn btn-primary">Update</a>
    </td>
