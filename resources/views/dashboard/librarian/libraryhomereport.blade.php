...
<div style="text-align:center; position: relative; width: 100%; margin: auto; color: #white; background-color: #787575; " class="container0">
    ...
    <div style="position: fixed; text-align:center; top: -1%; bottom: 76%; color:white; width: 100%; background-color:#787575;" class="content0" >
    ...
    <h2>Library Statistic Report</h2>Report Generated on :<?= $mytime->toDateString(); ?>
      <br>
      <a href="/librarian/download-pdf2" class="btn btn-primary">Download Report</a>
    </center>
...
<center><h4>Total:<?= ($feedback1 + $feedback2 + $feedback3) ?></h4></center>
