  ...
  <body>
    ...
    <nav class="navbar bg-dark">
      ...
      <ul>
        ...
        <li><a href="/librarian/manage-libraryitems">Library</a></li>
        <li><a href="#">Q & A</a></li>
    ...
    <section class="container">
      ...
      <form action="{{route ('librarian.check')}}" method="POST" class="form">
      {{ method_field('POST')}}
            @if (Session::get('fail'))  
        ...
        <div class="form-group">
          ...
          <p class="my-1">
            <a href="{{route('librarian-forgot-password')}}">Forgot Password?</a>
         </p>
        </div>
      </form>
      <!-- <p class="my-1">
