...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
        <form class="row g-3" mehod="post" action="{{ route('Equestion.add') }}" enctype="multipart/form-data">
        {{ method_field('POST') }}
            @csrf
            ...
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" name="e_ID" value="{{$manageexam->id}}" readonly hidden>
            </div>

            <div class="col-md-6">
                <label class="form-label">Exam Title</label>
                <input type="text" class="form-control" name="e_title" value="{{$manageexam->e_title}}" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="examQuestionOptionA" required>
            </div>

            <div class="form-group">
                <label>Option B</label>
                <input type="text" class="form-control" name="examQuestionOptionB" required>
            </div>

            <div class="form-group">
                <label>Option C</label>
                <input type="text" class="form-control" name="examQuestionOptionC">
            </div>

            <div class="form-group">
                <label>Option D</label>
                <input type="text" class="form-control" name="examQuestionOptionD">
            </div>
