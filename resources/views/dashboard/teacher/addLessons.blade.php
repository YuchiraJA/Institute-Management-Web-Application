...
margin-top: 0.3rem !important;
 ...
 <nav class="navigaation-bar background-dark">
   ...
   <div class="col-md-20">
    ...
    <input type="text" class="form-control py-2" pattern="[A-Za-z]+" title="Letters only" name="classLtype" placeholder="Enter the lesson type">
    </div><span class="text-danger">@error('type'){{$message}}@enderror</span>
    @error('classLtype')
    <div class="alert alert-success mt-1 mb-1">{{ $message }}</div>
    @enderror
    <br>
    ...
    <h4>Enter Subject</h4>
    <div class="form-group">
    <input type="text" class="form-control py-2" pattern="[A-Za-z]+" title="Letters only"  name="classLSubject" placeholder="Enter the lesson name">
    </div>
