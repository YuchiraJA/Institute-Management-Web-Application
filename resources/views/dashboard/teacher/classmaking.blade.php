...
margin-top: 0.3rem !important;
 ...
 <!-- @if(session('message'))
    ...
    <input type="text" class="form-control py-2"  pattern="[A-Za-z]+" title="Letters only" name="classType" placeholder=" AL/OL" >
    ...
    <h4>Enter Subject</h4>
    <input type="text" class="form-control py-2" pattern="[A-Za-z]+" title="Letters only"  name="classSubject" placeholder=" Subject">
    ...
    <h4>Enter Grade</h4>
    <input type="text" class="form-control py-2"  pattern="[0-9]{1,2}" name="classGrade" placeholder=" Grade" >
    ...
    <h4>Enter Fee</h4>
    <input type="text" class="form-control py-2" pattern="[0-9]{1,5}" title="Numbers only" name="classFee" placeholder=" Amount" >
        @error('classFee')
       <div class="alert alert-success mt-1 mb-1">{{ $message }}</div>
        @enderror
        <br><br>
