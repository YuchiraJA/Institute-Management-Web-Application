    ...
    <h2> Update Exam </h2>
        ...
        {{ method_field('POST') }}
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control py-2" name="examTitle" value="{{$manageexam->e_title}}">
                <span style="color:red"> @error('examTitle'){{$message}}@enderror</span>
            </div>

            <div class="col-md-6">
                <label class="form-label">Duration</label>
                <select class="form-select py-2" name="examDuration">
            ...
            <div class="col-md-3">
                ...
                <input type="date" class="form-control py-2" name="examDate" value="{{$manageexam->e_date}}">
                <span style="color:red"> @error('examDate'){{$message}}@enderror</span>
            </div>

            <div class="col-md-3">
                <label class="form-label">Exam Time</label>
                <input type="time" class="form-control py-2" name="examTime" value="{{$manageexam->e_time}}">
                <span style="color:red"> @error('examTime'){{$message}}@enderror</span>
            </div>

            <div class="col-md-6">
                <label class="form-label">No of Questions</label>
                <input type="text" class="form-control py-2" name="examNoOfQuestions" value="{{$manageexam->no_of_questions}}">
                <span style="color:red"> @error('examNoOfQuestions'){{$message}}@enderror</span>
              </div>

            <div class="col-md-6">
                <label class="form-label">Enrollment Key</label>
                <input type="text" class="form-control py-2" name="examEnrollmentKey" value="{{$manageexam->e_key}}">
