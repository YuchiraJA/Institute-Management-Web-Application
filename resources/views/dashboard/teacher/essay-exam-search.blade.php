...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-md-4"  style="margin-left:650px">
      <form action="/searchEssayExam" method="get">
        <div class="input-group">
          <input type="search" name="search" class="form-control" name="Search exams">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table width="100%">
                                                <tr>
                                                    <td>
                                                        <a href="/teacher/addEssayQuestion/{{$manageexam->id}}" class="btn btn-primary"> Add </a>
                                                    </td>  
                                                    ...
                                                    <td> 
                                                        <a href="/teacher/viewEssayQuestion/{{$manageexam->id}}" class="btn btn-dark"> View</a>
                                                    </td>
                                                </tr>    
                                            </table>
                                        </td>        
