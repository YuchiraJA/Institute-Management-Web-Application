  ...
  <div class="column2">
    <div class="card2">
      ...
      <a href="/librarian/manage_libraryitems"><h2>E-Books</h2></a>
        ...
        <p></p>
        <p style="text-colour:white"><a href="/librarian/manage_libraryitems" class="button2">View</a></p>
  ...
  <div class="column2">
    <div class="card2">
      ...
      <a href="/librarian/manage_papers"><h2>Past Papers</h2></a>
        ...
        <p></p>
        <p style="text-colour:white"><a href="/librarian/manage_papers" class="button2">View</a></p>
      </div>
    </div>
  </div>
  ...
  <div class="column2">
    <div class="card2">
      ...
      <a href="/librarian/manage_libraryitems"><h2>Journals</h2></a>
        ...
        <p></p>
        <p><a href="/librarian/manage_libraryitems" class="button2">View</a></p>
      </div>
    </div>
  </div>
</div>
