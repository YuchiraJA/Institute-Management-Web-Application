...
<html lang="en">
  <head>
    ...
    <title>Manage Essay Questions</title>
    <link
      rel="stylesheet"
                                        ...
                                        <td>
                                            <table>
                                                <tr> 
                                                    ...
                                                    <td> 
                                                        <a href="/teacher/editEssayQuestion/{{$row->id}}" class="btn btn-success"> Update </a>
                                                    </td> 

                                                    <td> 
                                                        <a href="/teacher/deleteEQuestion/{{$row->id}}" class="btn btn-danger"> Delete </a>
                                                    </td> 
                                                </tr>    
                                            </table>
                                        </td>        
