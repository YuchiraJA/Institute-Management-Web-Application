                                        ...
                                        <td>
                                            <table>
                                                <tr> 
                                                    ...
                                                    <td> 
                                                        <a href="/teacher/viewStdAnswer/{{$row->std_id}}/{{$row->e_id}}" class="btn btn-warning"> View </a>
                                                    </td> 

                                                    <td> 
                                                        &nbsp &nbsp <a href="/teacher/approveStdAnswer/{{$row->std_id}}" class="btn btn-primary"> Approve </a>
                                                    </td>
