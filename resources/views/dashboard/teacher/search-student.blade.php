...
<body>
    ...
    <!-- <h2 class="my-2 text-center large text-primary fw-bold">Current Students List in MicroEye</h2> -->
        ...
        <h2 class="my-1 large text-primary fw-bold">Searched Student</h2>
    
        <!-- <span class="search-bar">
        <form type="get" action="{{url ('teacher.search-student')}}">
            <input style="padding: 0.7rem 0 !important; width: 600px;" class="form-control text-center mb-3" type="text" value="" name="query" placeholder="Search Student Using ID" aria-label="readonly input example" >
        </form>
          ...
          <tr>
            ...
            <td>
              <button class="btn btn-success">
                  <i class="fas fa-user-check"></i><a style="color: #fff !important;" href="{{'student-attendance-details/'.$users->id}}"> Mark Attendace</a> 
              </button>
            </td>
          </tr>
...
<!--         
         <div class="report">
                <button class="btn btn-success">
                  <i class="fas fa-print"></i><a style="color: #fff !important;" href="{{'search-student/'.$users->id}}"> Generate Report</a> 
                </button>
          </div> -->
          @endforeach
      </section>
