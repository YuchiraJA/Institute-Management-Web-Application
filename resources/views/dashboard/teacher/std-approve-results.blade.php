...
<html lang="en">
  ...
  <body>
    ...
    <br> <br>    
    <h2> Approve Students' Results </h2>
    </div>

        <section class="container">

        <form action="{{ route('Result.approvedMarks') }}" method="post">
        ...
        <div class="col-md-6">
                ...
                <input type="text" class="form-control py-2" name="std_name" required readonly value="{{$student->first_name}} {{$student->last_name}}">   
        </div>

        <br>

        <div class="col-md-6">   
                <input type="text" class="form-control py-2" name="std_id" required readonly value="{{$student->std_id}}">   
        </div>

        <br>

        <div class="col-md-6">   
                <input type="text" class="form-control py-2" name="e_id" required readonly value="{{$student->e_id}}">   
        </div>
        ...
        <div class="col-md-6">
                ...
                <input type="text" class="form-control py-2" name="std_marks" required value="{{$student->sum}}">   
        </div>
        @endforeach
        ...
        <div class="col-md-6">
                ...
                <textarea class="form-control rounded-0" rows="10" name="t_feedback" id='editor'></textarea>  
        </div>

        <div class="col-md-6">
                <label class="form-label">Approved By</label>  
                <input type="text" class="form-control py-2" name="t_name" required value="{{Auth::user()->first_name}} {{Auth::user()->last_name}}" readonly>     
                <input type="text" class="form-control py-2" name="t_id" required value="{{Auth::user()->id}}" readonly>   
        </div>
