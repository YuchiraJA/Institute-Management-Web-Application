  ...
  @if(Auth::guest())
   ...
   @if(session()->exists('message'))
    ...
    <input type="hidden" name="id" value="{{$data->id}}">
     ...
     <input type="text" class="form-control" name="classType" value="{{$data->c_type}}" >
     <br><br>
    <input type="text" class="form-control" name="classSubject" value="{{$data->subject}}">

    <br><br>
    <input type="text" class="form-control" name="classGrade" value="{{$data->grade}}">
    <br><br>
    <input type="text" class="form-control" name="classFee" value="{{$data->fee}}" >
    <br><br>
