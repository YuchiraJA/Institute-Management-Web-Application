...
<html lang="en">
  <head>
    ...
    <title>View Students' Essay Answers</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <h2> Students' Answers </h2>
        ...
        <form method="post" action="{{ route('Result.approvedEssayQMarks') }}">
            @csrf
        ...
        <table class="table table-striped">
          <tr> 
            ...
            <td> 
                {!!$student->question!!} 
                <br>
                <input type="text" name="std_id" value="{{$student->std_id}}" name="std_id" readonly>
                <input type="text" name="e_id" value="{{$student->e_id}}" name="e_id" readonly>
                <input type="text" name="std_id" value="{{$student->std_id}}" name="t_id" readonly>  
            </td>
          ...
          <tr>
            ...
            <td>             
                <div class="col-md-3">
                    <input type="text" class="form-control py-2" name="std_marks" required>
                </div>
        ...
        <tr>
            <th> Feedback </th>
            <td> <textarea class="form-control rounded-0" rows="10" name="t_feedback" id='editor{{$student->id}}'></textarea> </td>
        ...
        <script src="/js/ckeditor.js"> </script>
            <script>
                CKEDITOR.replace('editor{{$student->id}}',
                {
