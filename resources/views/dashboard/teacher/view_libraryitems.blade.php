...
<br>
  ...
  <!-- <td>{{$libraryitem->id}}</td>   -->
   <td><img src="{{ asset('uploads/'.$libraryitem->file) }}" width="10px" height="300px"></td>
    <td><b>Item Name :</b> {{$libraryitem->Item_name}} <br><b> Author :</b> {{$libraryitem->Author}}  <br> <b>Item Type :</b> {{$libraryitem->Item_type}}</td>
    <td><b>Item Details :</b> {{$libraryitem->Item_details}}</td>
    <td><center><a href={{$libraryitem->Item_link}} class="btn btn-success">View/Download</a></center></td>
  </tr>
  @endforeach
