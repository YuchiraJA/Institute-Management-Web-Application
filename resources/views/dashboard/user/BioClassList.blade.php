...
<meta charset="UTF-8" />
    ...
    <title>Biology Class list</title>
    <style>
body {
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <img src="/images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h6><b>Niluka Bandara</b></h6>
     <h5><b>Biology</b></h5>

    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/user/Biology" name="btn-1" class="btn btn-primary">View</a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <img src="/images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h6><b>Niluka Bandara</b></h6>
     <h5><b>Biology Paper Class</b></h5>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/user/bio-paper " name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
