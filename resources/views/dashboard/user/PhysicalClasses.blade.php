...
<meta charset="UTF-8" />
    ...
    <title>Physical Science Class list</title>
...
<center>
    <h2>Physical Science Classes</h2>
  <br>
<i>
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <img src="/images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h6><b>Hemantha Ariyasena</b></h6>
     <h5><b>Physics</b></h5>
    </div>
    <div class="flip-card-back">
      
    <br><br><br>
    <a href="/user/Physics" name="btn-1" class="btn btn-primary">View</a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <img src="/images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h6><b>Pasan Deegodagamage</b></h6>
     <h5><b>Chemistry</b></h5>

    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/user/Chemistry" name="btn-1" class="btn btn-primary">View</a>
...
<div class="flip-card">
  <div class="flip-card-inner">
    <div class="flip-card-front">
    <img src="/images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h6><b>Subash Rathnayake</b></h6>
     <h5><b>Combined Maths</b></h5>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/user/Com-math " name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <img src="/images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h6><b>Hemantha Ariyasena</b></h6>
     <h5><b>Physics paper Class</b></h5>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/user/physics-paper" name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <img src="/images/classTeacher2.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h6><b>Harshana Kahadawala</b></h6>
     <h5><b>Chemistry Paper Class</b></h5>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
...
<div class="flip-card">
  <div class="flip-card-inner">
    ...
    <img src="/images/classTeacher1.png" alt="Avatar" style="width:190px;height:250px;"><br>
     <h6><b>Subash Rathnayake</b></h6>
     <h5><b>Combined Paper Class</b></h5>
    </div>
    <div class="flip-card-back">
    <br><br><br><br>
    <a href="/user/Com-ppr " name="btn-1" class="btn btn-primary">View</a>
    </div>
  </div>
</div>
