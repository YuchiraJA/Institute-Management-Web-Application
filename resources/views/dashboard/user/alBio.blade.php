...
<section class="container">
        <center><h1 class="topic">A/L Bio Science (2024)</h1></center>
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13">Biology</span>
                                    <div class="margin-10px-top font-size14">1:30pm-6:30pm</div>
                                    <div class="font-size13 text-black">Tissa Jananayake</div>
                                </td>
        ...
        <center><h1 class="topic">A/L Bio Science (2023)</h1></center>
                <div class="timetable-img text-center">
                    <img src="img/content/timetable.png" alt="">
                </div>
                <div class="table-responsive">
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            <tr> 
                                ...
                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13">Biology Revision</span>
                                    <div class="margin-10px-top font-size14">3:30pm-6:30pm</div>
                                    <div class="font-size13 text-black">Niluka Bandara</div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="font-size13 text-black">Harshana Kahandala</div>
                                </td>
                                ...
                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13">Biology Paper Class</span>
                                    <div class="margin-10px-top font-size14">3:30pm-6:30pm</div>
                                    <div class="font-size13 text-black">Niluka Bandara</div>
                                </td>
        ...
        <center><h1 class="topic">A/L Bio Science (2022)</h1></center>
                <div class="timetable-img text-center">
                    <img src="img/content/timetable.png" alt="">
                </div>
                <div class="table-responsive">
