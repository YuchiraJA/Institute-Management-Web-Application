...
<br><br><br>
<center>
  <h2>Select Class Type</h2><br>
<form method="get"  action="{{ url('/user/redirect-ol') }}">
<input class="MyButton" type="submit" value="6-11 Classes" />
</form>
<br></br>
<form method="get"  action="{{ url('/user/redirect-bio') }}">
<input class="MyButton" type="submit" value="AL Biology Classes" />
</form>
<br><br>
<form method="get"  action="{{ url('/user/redirect-phy') }}">
<input class="MyButton" type="submit" value="AL Physical science Classes" />
</form>
<br><br>
<form method="get"  action="{{ url('/user/redirect-cmz') }}">
