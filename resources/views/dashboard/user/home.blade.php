...
<body>
      ...
      <ul>
        ...
        <li><a href="/user/studentSchedule">Timetables</a></li>
        <li><a href="/user/common-class">Classes</a></li>
        <li><a href="/user/studentnotice">Notices</a></li>
        <li><a href="/user/exam-introduction">Exams</a></li>
        <li><a href="/user/libraryHome">Library</a></li>
        <li><a href="{{route('user.q&a')}}">Q & A</a></li>
        <li><a href="/user/payment">Finance</a></li>
        <li>
      ...
      <div class="offcanvas-body">
        ...
        <div class="my-3">
          <ul class="lead">
              ...
              <li class="mb-2 ms-4"><a href="/user/publicTable" class="text-decoration-none">Classes Time-Table</a></li>
    ...
    <section class="container">
      ...
      <div class="dash-buttons">
        <a href={{"user-edit/".Auth::id()}} class="btn">
      ...
      <table class="table">
        ...
        @foreach($data as $users)
          <tr>
            ...
            <td class="hide-sm"> {{$users->mobile}} </td>
            <td class="hide-sm"> {{$users->address}} </td>
          </tr>
          @endforeach
        </tbody>
      </table>
      ...
      <div class="my-2">
        <button class="btn btn-danger" href="{{route ('user.logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> <i class="fas fa-sign-out-alt"></i> Logout</a>
