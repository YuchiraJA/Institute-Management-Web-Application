    ...
    <br> <br>    
        ...
        <table class="table table-striped">
          ...
          <tr>
            ...
            <td> <font color="blue"> <b> {{$student->marks}} </b> </font> </td>

            <td>  <a href="/user/myAnswers/{{Auth::user()->id}}/{{$student->e_id}}" class="btn btn-warning" target="_blank"> View </a> </td>
        ...
        <div class="offcanvas-body">
          ...
          <div class="my-3">
            <ul class="lead">
                ...
                <li class="mb-2"><a href="/teacher/approve-result" class="text-decoration-none">Student Result</a></li>
            </ul>
          </div>
        </div>
      </div>
