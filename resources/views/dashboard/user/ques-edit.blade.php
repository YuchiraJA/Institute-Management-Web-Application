...
<body>
    ...
    <section class="container">
      ...
      <h2 class="my-2">Edit My Questions</h2>
      
        <form action="{{route('user.ques-editsave')}}" method="post">
        @csrf
        <div class="form-group">
        <input type="hidden" name="id" value="{{$update_data->id}}"/>

          <input type="text" placeholder="Title" name="Title" value="{{$update_data->Title}}"/>
          <span class="text-danger">@error('Title'){{$message}}@enderror</span>
        </div>
        <div class="form-group">
          <input type="text" placeholder="Description" name="Description" value="{{$update_data->Description}}" />
          <span class="text-danger">@error('Description'){{$message}}@enderror</span>
        </div>
        <div class="form-group"> 
          <input type="submit" value="Update My Question"  class="btn btn-success" />
        </div>
