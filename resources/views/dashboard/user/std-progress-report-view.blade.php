    ...
    <h2> My Progress Report </h2>
        ...
        <table id="report">
          ...
          <tr>
            ...
            <td> <font color="green"> <b> {!!$student->feedback!!} </b> </font> </td> 
        ...
        <div class="col-12">
                <a href="/user/download-pdf/{{Auth::user()->id}}" class="btn btn-primary">
                  DOWNLOAD YOUR PROGRESS REPORT 
                </a>
                
                <a href="/user/myExam/{{Auth::user()->id}}" class="btn btn-warning">
                  MY EXAMS 
                </a>
        </div> 
