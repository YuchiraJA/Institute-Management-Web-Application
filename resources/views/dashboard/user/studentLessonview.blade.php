       ...
       Classes         
          ...
          <div class="my-3">
            ...
            <li class="mb-2"><a href="Ladd" class="text-decoration-none">View Profile</a></li>
                <li class="mb-2"><a href="/user/common-classes" class="text-decoration-none">Class List</a></li>
            </ul>
          </div>
        </div>
      </div>
...
<form  action="/user/search-subject" method="post">
{{@csrf_field()}}
<div class="input-group">
  <input type="search" placeholder="Enter subject" name="search">
...
<thead>
    ...
    <td><a href="/file/download/{{$Lesson->file}}" class="btn btn-danger">Download</a></td>
        </tr>
        @endforeach
</tbody>
</table>
