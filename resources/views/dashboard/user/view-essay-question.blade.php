...
<html lang="en">
  ...
  <div id="container">
    ...
    <form method="post"  action="{{ route('Exam.essayanswer') }}">
      @csrf
    ...
    <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <div class="ml-md-3 ml-sm-3 pl-md-5 pt-sm-0 pt-3" id="options"> 
            ...
            <div class="form-group">
                <label>Write your answer in the space provided below</label>
                <textarea class="form-control rounded-0" rows="10" name="std_answer" id='editor'></textarea>
            </div>

            <br> <br>

            <input type="text" value="{{Auth::user()->id}}" name="std_id" hidden>
