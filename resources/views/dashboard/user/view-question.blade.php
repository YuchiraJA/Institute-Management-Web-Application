...
<html lang="en">
  ...
  <div id="container">
    ...
    <form method="post"  action="{{ route('answer/save') }}">
      @csrf
    ...
    <div class="question ml-sm-5 pl-sm-5 pt-2">
        ...
        <div class="ml-md-3 ml-sm-3 pl-md-5 pt-sm-0 pt-3" id="options"> 
            <label class="options"> {{$row->option_a}}
                <input type="checkbox" name="std_answer[]" class="{{$row->e_id}}" value="{{$row->option_a}}"> 
                    <span class="checkmark"></span> 
            </label> 
            
            <label class="options"> {{$row->option_b}}
                <input type="checkbox" name="std_answer[]" class="{{$row->e_id}}" value="{{$row->option_b}}"> 
                    <span class="checkmark"></span> 
            </label> 
                
            <label class="options"> {{$row->option_c}}
                <input type="checkbox" name="std_answer[]" class="{{$row->e_id}}" value="{{$row->option_c}}"> 
                <span class="checkmark"></span> 
            </label>
                
            <label class="options"> {{$row->option_d}} 
                <input type="checkbox" name="std_answer[]" class="{{$row->e_id}}" value="{{$row->option_d}}"> 
                <span class="checkmark"></span> 
            </label> 

            <input type="text" value="{{$row->id}}" name="q_id[]" hidden>
            <input type="text" value="{{$row->e_id}}" name="e_id[]" hidden>
...
<center> <h1> Please download your recorded video before submitting your answers </h1> </center>
