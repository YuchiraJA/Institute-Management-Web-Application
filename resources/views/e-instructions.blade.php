  ...
  <body>
    ...
    <br>
      ...
      <p>
        ...
        earum ad voluptatibus culpa ducimus dignissimos illo neque aliquam quas
        delectus fuga, quod a molestiae necessitatibus temporibus quo quis odio
        reiciendis vero vitae eius? Maxime alias harum ipsa soluta enim
        doloribus fuga, iste natus deserunt omnis molestiae vel pariatur
        temporibus, eos nobis cupiditate magni accusamus minus magnam fugit
        rerum suscipit, voluptas illum quo! Sequi, modi ipsam. Distinctio
        dolore, voluptates quisquam delectus culpa odio explicabo tempora maxime
        officia.
      </p>
      <p>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloribus
      ...
      <form class="row g-3" nethod="post"  action="{{ route('Exam.checkEkey') }}">
        @if(Session::get('fail'))
