...
<section class="container">
        <center><h1 class="topic">Grade 8 Time-Table</h1></center>
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16 xs-font-size13">IT</span>
                                    <div class="margin-10px-top font-size14">3:30pm-5:30pm</div>
                                    <div class="font-size13 text-black">Ajith Muthukumara</div>
                                </td>
                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13">Tamil</span>
                                    <div class="margin-10px-top font-size14">3:30pm-5:30pm</div>
                                    <div class="font-size13 text-black">Aadvika Saahana</div>
                                </td>

                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13">Mathematics</span>
                                    <div class="margin-10px-top font-size14">3:30pm-5:30pm</div>
                                    <div class="font-size13 text-black">Ranjih Suriyapperuma</div>
                                </td>
                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13">Sinhala</span>
                                    <div class="margin-10px-top font-size14">3:30pm-5:30pm</div>
                                    <div class="font-size13 text-black">Upul Rupasinha</div>
                                </td>
                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13">History</span>
                                    <div class="margin-10px-top font-size14">3:30pm-5:30pm</div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="bg-green padding-5px-tb padding-15px-lr border-radius-5 margin-10px-bottom text-white font-size16  xs-font-size13">Science</span>
