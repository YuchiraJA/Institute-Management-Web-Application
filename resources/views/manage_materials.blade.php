...
<div class="container2">
    ...
    <form action="/save_material" method="post" style="border:1px solid #ccc">
    {{csrf_field()}}
...
<table id="customers">
  <tr>
    ...
    <th width="9%">Added By (Teacher's Name)</th>
  ...
  <tr>
    ...
    <td>  
    <a href="/deletematerial/{{$material->id}}" id="btn1" class="btn btn-warning">Delete</a>
    <a href="/updatematerial/{{$material->id}}" id="btn2" class="btn btn-primary">Update</a>
    </td>
