...
<div class="container2">
    ...
    <form action="/save_paper" method="post" style="border:1px solid #ccc">
    {{csrf_field()}}
...
@foreach($errors->all() as $error)
        ...
        @endforeach
               <hr>
                ...
                <input type="text" placeholder="Enter Paper Name" name="papername" required>
                 <br>
               ...
               <input type="text" placeholder="Enter Year" name="year">
                ...
                <br>
                 <label for="medium"><b>Grade</b></label><br>
                ...
                <label for="subject"><b>Link</b></label><br>
                 <textarea id="subject" name="link" placeholder="Enter paper link.." style="height:200px"></textarea>
         <br>
     <br>
    <div class="clearfix">
...
<table id="customers">
  ...
  <tr>
    ...
    <td>{{$paper->Grade}}</td>
    <td>{{$paper->Medium}}</td>
    <td><a href={{$paper->Paper_link}}>link</a>{{$paper->Paper_link}}</td>
    <td>    
    <a href="/deletepaper/{{$paper->id}}" class="btn btn-danger">Delete</a>
    <a href="/updatepaper/{{$paper->id}}" class="btn btn-success">Update</a>
    </td>
