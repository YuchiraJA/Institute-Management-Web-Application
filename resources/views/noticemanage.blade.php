...
<table class="table table-striped">
 ...
 <tr>
     ...
     <td width="200px">
       <a href="/deleten/{{$item->id}}" class="btn btn-danger">DELETE</a>
       <a href="/editnotice/{{$item->id}}" class="btn btn-warning">UPDATE</a>
    </td>
</tr>
@endforeach
