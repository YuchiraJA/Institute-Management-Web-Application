...
<br><br><br>
    <h2 style="text-align: center">Salary Table</h2>


    <div class ="col_md-4" style="margin-left:1100px ">
      <form action="/searchSalaryDetails" method="get" style="width: 40%; ">
       <div class="input-group">
         <input type="search" name="search" class ="form-control" placeholder="Teacher ID">
...
@endif
    ...
    <table class="table table-striped" style="text-align: center; margin:50px 100px 100px 100px; width: 80%;">
  <thead>
    <tr>
  ...
  <tbody>
  @foreach($data as $Financial_salary )
    <tr>
   
      <!-- <th scope="row">1</th> -->
      <td>{{$Financial_salary->id}}</td>
      <td>{{$Financial_salary->teacher_id}}</td>
      <td>{{$Financial_salary->month}}</td>
      <td>{{$Financial_salary->amount}}</td>
      <td> <a href="{{ url('edit/' .$Financial_salary->id)}}" class="btn btn-warning" style="color:black !important">Edit</a></td>
    </tr>
   @endforeach
