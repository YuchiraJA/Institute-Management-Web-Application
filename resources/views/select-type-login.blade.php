...
<div class="card text-center">
    ...
    <div class="card-body">
        ...
        <p class="card-text py-2 ">Select whether you are a student, teacher, administrator, librarian or accountant</p>
        @if (Route::has('user.register'))
        <a href="{{route("user.login")}}" class="btn btn-primary mb-5 py-1">Student</a>
        @endif
        <a href="{{route ('teacher.login')}}" class="btn btn-primary mb-5 py-1">Teacher</a>
        <a href="{{route ('admin.login')}}" class="btn btn-primary mb-5 py-1">Administator</a>
        <a href="{{route ('accountant.login')}}" class="btn btn-primary mb-5 py-1">Accountant</a>
        <a href="{{route ('librarian.login')}}" class="btn btn-primary mb-5 py-1">Librarian</a>
