  ...
  <body>
    ...
    <nav class="navigaation-bar background-dark">
      ...
      <ul>
        ...
        <li><a href="/studentnotice">Notices</a></li>
    ...
    <!-- Sidebar -->
      ...
      <div class="offcanvas-body">
        ...
        <div class="my-3">
          <ul class="lead">
              <li class="mb-2 ms-4"><a href="/studentnotice" class="text-decoration-none">Student Noticebord</a></li>
              <li class="mb-2 ms-4"><a href="/get-all-notices" class="text-decoration-none">Generate Reports</a></li>
...
<div class="col-md-4">
  <form action="{{url('/studentsearch')}}" method="get">
  {{csrf_field()}}
