  ...
  <body>
    ...
    <br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <a href="/getEssayExam/{{$row->id}}" class="btn btn-success"> Launch </a>
                                                    </td>  
                                                </tr>    
                                            </table>
                                        </td>        
        ...
        <div class="offcanvas-body">
          ...
          <div class="my-3">
            <ul class="lead">
                <li class="mb-2"><a href="#" class="text-decoration-none">MCQ Exams</a></li>
                <li class="mb-2"><a href="#" class="text-decoration-none">Essay Exams</a></li>
